...
# Biglib enable/disable
%if "%{?enable_biglib:set}" != "set"
%define enable_biglib 1
%endif
...
%endif
%if "%{?release_userldflags:set}" == "set"
echo '<flags LDFLAGS="%{release_userldflags}"/>' >> %_builddir/config/BuildFile.xml
%endif
