...
patches:
  ...
  - miopen-disable-clang-tidy.patch
build_requires:
  - CMake
  - gmake
  - rocm-cmake
...
patch -p2 -d "$BUILDDIR/rocm-libraries/projects/miopen" < "$SOURCEDIR/miopen-boost-optional-fix.patch"
patch -p1 -d "$BUILDDIR/rocm-libraries/projects/miopen" < "$SOURCEDIR/miopen-ciso646.patch"
patch -p1 -d "$BUILDDIR/rocm-libraries/projects/miopen" < "$SOURCEDIR/miopen-disable-clang-tidy.patch"
